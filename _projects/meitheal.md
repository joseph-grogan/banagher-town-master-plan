...
The Banagher Town Masterplan lists 25+ community projects. Many of them — Tidy Towns,
Fort Falkland, the Graveyard Signage project, the Photo Archive, community events — regularly
need volunteers for short bursts of work. Right now there's no single, easy way to rally people.

The Meitheal is the engine that connects willing hands to real tasks. It's not just another
project on the list — it's the thing that helps all the other projects move.
...
Every call-out posted to the group follows the same simple format:

> **📋 MEITHEAL CALL-OUT**
>
> **What:** Plant flower beds at the Marina entrance<br>
> **When:** Saturday 20th September, 10am–12pm<br>
> **Where:** Meet at the Marina car park<br>
> **Bring:** Gloves if you have them — tools provided<br>
> **Contact:** Johnny (087-XXX-XXXX)
>
...
| **Day after** | Post photos from the event to the group + social media |
| **Following week** | Line up the next 2 call-outs |

---

## Keeping It Alive

- **Steady rhythm** — aim for 1–2 call-outs per month minimum.
- **Show the impact** — post 2–3 photos and a short update after each event.
- **Rotate the source** — one month it's planting, next it's event setup, next it's heritage.
- **Welcome newcomers** — a quick message when someone new joins goes a long way.
- **Celebrate milestones** — "10 events done!" / "50 members!" — small wins build momentum.
- **Review at 3 months** — is it working? Does the coordinator role need to rotate?

---

## Projects That Need Meitheal Support

| Project | How Meitheal Helps |
|---------|-------------------|
| Banagher Tidy Towns | Weekly cleanups, planting days |
| Fort Falkland | Event setup, site maintenance |
| Graveyard Signage | Committee formation, physical work |
| Photo Archive | Collection drives, scanning sessions |
| Sionn Mhara | Launch events, crewing |
| Christmas Lights | Installation and takedown |
| Community Events | Setup, stewarding, teardown |
